...
describe('Multiple signer pdf signing', () =>{
    ...
    it('signs a pdf using multiple signers', () => {
        ...
        //cy.get('.mat-stroked-button',{ timeout : 15000, retryInterval: 3000 }).click()
        cy.get('.mat-flat-button',{ timeout : 15000, retryInterval: 3000 }).click()

        cy.get('tbody > :nth-child(1) > .cdk-column-status',{ timeout : 15000, retryInterval: 3000 }).should('contains.text', 'Signed')
